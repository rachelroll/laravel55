<div class="blog-masthead">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li>
                <input name="query" type="text" value="" class="form-control" style="margin-top:10px" placeholder="搜索词" id="search">
            </li>
            <li>
                <button class="btn btn-default" style="margin-top:10px" type="submit" action="/posts/search" id="sub">搜索!</button>
            </li>
        </ul>
